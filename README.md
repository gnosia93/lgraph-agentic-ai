...
* L10. LLM 배포하기
   ...
   - [bifrost 게이트웨어로 Fallback 구성 하기](https://github.com/gnosia93/lg-agentic-ai/blob/main/lesson/10-bifrost-fallback.md)
...
* [promptfoo로 모델 취약점 점검하기](https://github.com/gnosia93/langgraph-agentic-ai/blob/main/lesson/a7.promptfoo-security.md)
